...
public class AjoutOffreForm extends BaseForm {
    ...
    public AjoutOffreForm(Resources res ) {
        ...
        //
        TextField tfnomoffre = new TextField("", "nom offre ");
        ...
        v.addConstraint(tfnomoffre , new RegexConstraint("[a-zA-Z]", "Format Nom Invalide"));
        v.addConstraint(tfdescription, new RegexConstraint("[a-zA-Z]", "Format Prénom Invalide"));
        ...
        btnValider.addActionListener((e) -> {
            ...
            try {
                    ...
                    if ((tfnomoffre.getText().length()==0)||(tfdescription.getText().length()==0))
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                else
                {   
                    Offres u = new Offres(tfnomoffre.getText(), tfdescription.getText(), tftype.getText());
                    InfiniteProgress ip = new InfiniteProgress(); //Loading  after insert data
                    final Dialog iDialog = ip.showInfiniteBlocking();

                    if( ServiceOffres.getInstance().addOffres(u)){                            
                        iDialog.dispose();
