 ...
 * @author aymen
 */
public class ReclamationActif extends BaseForm {
     Form current;

    public ReclamationActif(Resources res) {
...
//        final Dialog ipDlg = ip.showInifiniteBlocking();
        ...
        recActifs.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(recActifs, arrow);
        });
        ...
        ArrayList<Reclamation> list = ServiceReclamation.getInstance().getReclamationActif();
    ...
    private void addButton(Image img,Reclamation rec , Resources res) {
        ...
        Label dateTxt = new Label("Etat : "+rec.getEtat(),"NewsTopLine2");
        Label etatTxt = new Label("Date Reclamation : "+rec.getDateRecString(),"NewsTopLine2" );
