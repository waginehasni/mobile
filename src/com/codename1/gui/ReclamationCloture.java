...
import com.codename1.gui.ViewReclamation;
import com.codename1.components.InfiniteProgress;
import com.codename1.components.ScaleImageLabel;
import com.codename1.components.SpanLabel;
import com.codename1.gui.AjoutReclamationForm;
import com.codename1.gui.BaseForm; 
import com.codename1.gui.ReclamationActif;
 ...
 * @author aymen
 */
public class ReclamationCloture extends BaseForm {
    Form current;
    public ReclamationCloture(Resources res) {
        ...
        RadioButton recActifs = RadioButton.createToggle("Actifs", barGroup);
        recActifs.setUIID("SelectBar");
        RadioButton recCloture = RadioButton.createToggle("Cloturées", barGroup);
...
//        final Dialog ipDlg = ip.showInifiniteBlocking();
        ...
        recCloture.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(recCloture, arrow);
        });
        ...
        ArrayList<Reclamation> list = ServiceReclamation.getInstance().getReclamationCloture();
    ...
    private void addButton(Image img,Reclamation rec , Resources res) {
        ...
        Label objetTxt = new Label("Date Reclamation  : "+rec.getDateRecString(),"NewsTopLine2");
        Label objetTxt1 = new Label("Traité le : "+rec.getDateRepString(),"NewsTopLine2");
        Label dateTxt = new Label("Titre : "+rec.getTitre(),"NewsTopLine2");
        ...
        FontImage mFontImage = FontImage.createMaterial(FontImage.MATERIAL_MODE_COMMENT, modifierStyle);
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ViewReclamation(res,rec).show();
        });
