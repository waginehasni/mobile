 ...
 * @author asus
 */
public class ReservationsListForm extends BaseForm{
    Form current;
    public ReservationsListForm(Resources res) {
    ...
    private void addButton(Image img,Reservation r , Resources res) {
        ...
        Label reservTxt = new Label("NumSalles : "+r.getNumSalles(),"NewsTopLine2");
            Label nomTxt = new Label("Specialité : "+r.getSpecialite(),"NewsTopLine2");
        Label nomcoachTxt = new Label("Date : "+r.getDate(),"NewsTopLine2" );
        Label typeTxt = new Label("Horraire : "+r.getHorraire(),"NewsTopLine2" );
        Label prixTxt = new Label("Durée : "+r.getDuree(),"NewsTopLine2" );
